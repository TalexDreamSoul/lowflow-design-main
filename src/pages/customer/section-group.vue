        ...
        <el-form-item v-show="form.planB">
          <div class="pannel">
            ...
            justify-content: space-between;">
              <div>
                <el-text>且在</el-text>&nbsp;
                <el-input v-model="triggerRuleContent.delayedTime" type="number" style="width: 100px" />&nbsp;
                <el-select v-model="triggerRuleContent.delayedUnit" style="width: 150px">
                ...
                &nbsp;
                <el-select v-model="triggerRuleContent.delayedAction" style="width: 150px">
