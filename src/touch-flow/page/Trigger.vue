...
<template>
  <el-select class="trigger-container" v-model="model" filterable :placeholder="ph">
    ...
    <el-option v-else v-for="item in attrs" :key="item.field" :label="item.fieldName" :value="item.fieldValue" />
  </el-select>
</template>
